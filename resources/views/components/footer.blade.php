        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="grid grid-cols-2 gap-8 xl:col-span-2">
                <div class="md:grid md:grid-cols-2 md:gap-8">
                    <div>
                        <h3 class="text-sm font-semibold leading-6 text-gray-900">Site</h3>
                    ...
                    <div class="mt-10 md:mt-0">
                        ...
                        <ul role="list" class="mt-6 space-y-4">
                            <li>
                                <a href="//mastodon.social/@muayth-ai" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Mastodon</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
{{--                </a>--}}
{{--            </div>--}}
            <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; 2023 silentpost, LLC. All rights reserved.</p>
        </div>
    </div>
</footer>
